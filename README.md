...
| Поле             | Значение                                |
|------------------|-----------------------------------------|
| ФИО              | [Амиростанов Аллахверди]                           |
| Группа           | [РПО-2]                                |
| Дисциплина       | Git и GitHub                            |
| Дата выполнения  | [17.06.2026]                            |
| Ссылка на GitHub | [https://github.com/Za4nik/kontrol_git_rpo]                   |
...
Fetch - синхронизирует изменение с github, но не загужает. Pull синхр и загружает

## Конфликт и его решение

При измене двух файлов на разных ветках возникает конфликт. Для решения либо игнорируется один или оба сливаеются в единый
...
Мы научились пользоваться github. Подкрепили знания в использовании push и merge
